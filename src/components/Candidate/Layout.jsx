      ...
      <table className="text-left text-base text-gray-500 flex flex-col justify-center">
        <thead className="">
          <tr className="hidden 2xl:xl:lg:grid grid-cols-4">
            ...
            <th
              scope="col"
              className="px-6 py-4 font-medium text-gray-900 grid justify-end"
            >
              Action
            </th>
          </tr>
              ...
              <tbody className="text-base xl:2xl:block grid" key={index}>
                <tr className="block xl:2xl:grid grid-cols-4">
                  <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
                    ...
                    <div className="">
                      <div className="font-medium text-gray-700 w-fit">
                        {user[id].name}
                      </div>
                  ...
                  <td className="px-6 py-4 w-fit">{user[id].rollno}</td>
                  <td className="px-6 py-4 w-fit">{user[id].department}</td>
                  <td className="px-6 py-4 grid justify-end">
